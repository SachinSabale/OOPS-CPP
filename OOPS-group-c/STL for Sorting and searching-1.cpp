/************************************************************************
Title:-Write C++ program using STL for Sorting and searching
\************************************************************************
/*
...
class Item 
{
 ...
 int cost;
 int code;
bool operator==(const Item& i1) //Boolean operators allow you to create more complex conditional statements if the comparison is false
 {
 if(code==i1.code)
